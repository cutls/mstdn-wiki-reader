...
大きなネコ耳型<sup>[\[9\]](#cite_note-9)</sup>の Bluetooth ヘッドホンをしていて、髪の毛は青碧色<sup>[\[10\]](#cite_note-10)</sup>で、藍ちゃんと概ね似たようなセーラ服を着用している。
...
18. [↑](#cite_ref-18) QOTO では、Favicon がアニメーションしているため、#InstanceTicker では、初アニメーションアイコン設定となった
